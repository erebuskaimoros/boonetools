...
RPC_REST_URL_VALUE="${RPC_REST_URL:-https://rpc.thorchain.network}"
RPC_FALLBACK_REST_URL_VALUE="${RPC_FALLBACK_REST_URL:-https://gateway.liquify.com/chain/thorchain_rpc}"
...
RPC_REST_URL_FINAL="${RPC_REST_URL_VALUE:-${RPC_REST_URL:-https://rpc.thorchain.network}}"
RPC_FALLBACK_REST_URL_FINAL="${RPC_FALLBACK_REST_URL_VALUE:-${RPC_FALLBACK_REST_URL:-https://gateway.liquify.com/chain/thorchain_rpc}}"
...
RUJIRA_BASE_FEES_MIDGARD_URLS_VALUE="${RUJIRA_BASE_FEES_MIDGARD_URLS:-$MIDGARD_FALLBACK_URL_FINAL,$MIDGARD_URL_FINAL}"
RUJIRA_BASE_FEES_RPC_URLS_VALUE="${RUJIRA_BASE_FEES_RPC_URLS:-$RPC_FALLBACK_REST_URL_FINAL,$RPC_REST_URL_FINAL}"
...
RUJIRA_RESERVE_PAYMENTS_MIDGARD_URLS_VALUE="${RUJIRA_RESERVE_PAYMENTS_MIDGARD_URLS:-$MIDGARD_FALLBACK_URL_FINAL,$MIDGARD_URL_FINAL}"
RUJIRA_RESERVE_PAYMENTS_RPC_URLS_VALUE="${RUJIRA_RESERVE_PAYMENTS_RPC_URLS:-$RPC_FALLBACK_REST_URL_FINAL,$RPC_REST_URL_FINAL}"
...
TC_FEE_DASH_HEAD_LAG_DAYS_VALUE="${TC_FEE_DASH_HEAD_LAG_DAYS:-2}"
