...
rsync -avz src/lib/rapid-swaps/backend.js "$SERVER:$DEST/src/lib/rapid-swaps/"
rsync -avz src/lib/rapid-swaps/model.js "$SERVER:$DEST/src/lib/rapid-swaps/"
rsync -avz src/lib/rapid-swaps/reconciliation.js "$SERVER:$DEST/src/lib/rapid-swaps/"
