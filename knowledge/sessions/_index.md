...
- Site-wide readability pass: validated locally; production deploy pending clean, CI-green `main`
...
|------|-------|---------|------|
| 2026-07-30 #2 | Site-wide Readability Pass | Raised typography and contrast across every routed page, chart, briefing, and mobile layout | `sessions/2026-07-30/session-2.md` |
