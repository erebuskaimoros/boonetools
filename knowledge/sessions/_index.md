...
- App Layer generated-fee ingestion: dedicated Liquify RPC, forward head catch-up, batching, and completed-day reconciliation are deployed; monitor source freshness, the forward watermark, provider quota, and lane 03 reconciliation
- Wasm Arb Economics: the hidden production time-series dashboard with synchronized zoom and per-chart controls is live; monitor the remaining oracle source gap and history compaction
